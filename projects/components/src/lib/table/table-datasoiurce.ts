 ...
 */
export interface LibTableDataSourcePageEvent {
  pageIndex: number;
  pageSize: number;
  length: number;
}
 ...
 * Decoupled so that users can depend on either the legacy or MDC-based paginator.
 */
export interface LibTableDataSourcePaginator {
  page: Subject<LibTableDataSourcePageEvent>;
  pageIndex: number;
...
export class _LibTableDataSource<
  T,
  P extends LibTableDataSourcePaginator = LibTableDataSourcePaginator,
> extends DataSource<T> {
  ...
  _updateChangeSubscription() {
    ...
    const sortChange: Observable<any | null | void> = this._sort
      ...
      : observableOf(null);
    const pageChange: Observable<LibTableDataSourcePageEvent | null | void> = this._paginator
      ? (merge(
          this._paginator.page,
          this._internalPageChanges,
          this._paginator.initialized,
        ) as Observable<LibTableDataSourcePageEvent | void>)
      : observableOf(null);
...
export class LibTableDataSource<
  T,
  P extends LibTableDataSourcePaginator = LibTableDataSourcePaginator,
> extends _LibTableDataSource<T, P> {}
